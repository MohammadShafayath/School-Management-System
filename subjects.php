...
<?php } ?>
<?php
if($_GET['page'] == 'all-subjects'){ ?>
<div class="row">
	<div class="cell-md-12">
		<div data-role="panel" data-title-caption="All Subjects" data-collapsible="false" data-title-icon="<span class='mif-plus'></span>" class="m-1">
		<div class="p-2">
			<div class="row">
				<div class="cell-md-12">
					<div data-role="panel" data-title-caption="All subjects" data-collapsible="true" data-title-icon="<span class='mif-table'></span>" class="mt-3">
					<div class="p-2" >
						<table class="table striped table-border mt-3"
							...
							data-source="data/subjects-data.php"
